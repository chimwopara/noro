...
const PLATFORM_NAME  = 'NoroTouch';
const PLATFORM_URL   = 'https://norotouch.com';
...
<table width="100%" style="max-width:520px;background:#fff;border-radius:20px;overflow:hidden">
  <tr><td style="background:#E8175A;padding:28px 32px;text-align:center">
    <div style="font-size:22px;font-weight:800;color:#fff;letter-spacing:-.5px">Noro<span style="opacity:.75">Touch</span></div>
  ...
  <tr><td style="padding:32px 32px 0">
    ...
    <p style="font-size:15px;color:#3C3C3C;line-height:1.65;margin:0 0 24px">You're now part of NoroTouch — book verified makeup artists in Abuja by brand and vibe.</p>
  ...
  <tr><td style="padding:24px 32px;border-top:1px solid #EBEBEB">
    <p style="font-size:12px;color:#8A8A8A;margin:0;text-align:center">© 2026 NoroTouch Ltd · Abuja, Nigeria<br/>Questions? Just reply to this email.</p>
  </td></tr>
</table>
</td></tr>
</table>
...
<table width="100%" style="max-width:520px;background:#fff;border-radius:20px;overflow:hidden">
  <tr><td style="background:#E8175A;padding:24px 32px;text-align:center">
    <div style="font-size:20px;font-weight:800;color:#fff">NoroTouch</div>
  </td></tr>
  <tr><td style="padding:32px">
    ...
    <p style="font-size:12px;color:#8A8A8A;margin:0">Didn't create a NoroTouch account? You can safely ignore this email.</p>
  </td></tr>
...
<table width="100%" style="max-width:520px;background:#fff;border-radius:20px;overflow:hidden">
  <tr><td style="background:#E8175A;padding:28px 32px;text-align:center">
    <div style="font-size:20px;font-weight:800;color:#fff">NoroTouch · Artist</div>
  ...
  GmailApp.sendEmail(email, subject,
    `Hi ${firstName}, your NoroTouch artist application has been received. We'll review it within 48 hours.`,
